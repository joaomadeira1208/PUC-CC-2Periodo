...
public class AlgebraBooleana {
    ...
    // Método para substituir variáveis por seus valores binários em uma expressão
    // booleana.
    ...
    /*
     * Método para avaliar uma expressão booleana. Este método percorre o array de
     * caracteres procurando um ')', após ela volta no array procurando pelo '('
     * correspondente.
     * Após encontrar uma operação, ela verifica se essa operação está sujeita a
     * operação booleana NOT, AND ou OR e encontra a solução booleana a partir da
     * função correspondente.
     * Ela substitui a operação e os valores dentro dos parênteses pela solução da
     * operação e repete esse processo até que não haja mais operações dentro dos
     * parênteses.
     */
