...
public class PesquisaSequencial {
    ...
    // Método para realizar a pesquisa sequencial em um vetor.
    public boolean pesquisarVetor(String nome) {
        for(int i = 0; i < vetorJogadores.size(); i++) {
            Jogador jogador = vetorJogadores.get(i);
            comparacoes++;
            if(equalStrings(jogador.getNome(), nome)) {
                return true;
            }
        }
        return false;
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if(!equalStrings(entrada1, "FIM")) {
                ...
                pesquisaSequencial.inserirVetor(jogadorInsercao);
            }
         ...
         do {
            ...
            if(!equalStrings(entrada2, "FIM")) {
                ...
                boolean jogadorEncontrado = pesquisaSequencial.pesquisarVetor(nome);
        ...
        pesquisaSequencial.registroDeLog("800854", tempoExecucao);
