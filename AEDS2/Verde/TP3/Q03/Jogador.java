    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (!equalStrings(entrada, "FIM")) {
                ...
                pilhaSequencial.inserir(jogadorId);
            }
        ...
        for (int i = 0; i < quantidadeRegistros; i++) {
            ...
            if (equalStrings(splits[0], "I")) {
                ...
                Jogador jogadorRemovido = pilhaSequencial.remover();
        ...
        for (int i = 0; i < jogadoresRemovidos.size(); i++) {
            MyIO.println("(R) " + jogadoresRemovidos.get(i).getNome());
        }

        pilhaSequencial.imprimir();
...
class PilhaSequencial {
    ...
    public void imprimir() {
        for (int i = 0; i < n; i++) {
            MyIO.println("[" + i + "]" + " ## " + pilha.get(i).getNome() + " ## " + pilha.get(i).getAltura()
                    + " ## " + pilha.get(i).getPeso() + " ## " + pilha.get(i).getAnoNasc() + " ## "
                    + pilha.get(i).getUniversidade()
                    + " ## " + pilha.get(i).getCidadeNasc() + " ## " + pilha.get(i).getEstadoNasc() + " ##");
        }
    }
}
